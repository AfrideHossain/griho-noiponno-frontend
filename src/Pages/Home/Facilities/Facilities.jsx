...
const Facilities = () => {
  return (
    <div className="facilities" data-aos="zoom-in-up">
      <div className="facilities-items flex md:flex-row flex-col items-center justify-between md:gap-14 gap-0 px-10 md:py-5 py-0 backdrop-blur-md rounded-xl mt-10 md:divide-y-0 divide-y divide-gray-600">
